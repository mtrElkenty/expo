---
title: Camera
sourceCodeUrl: 'https://github.com/expo/expo/tree/sdk-41/packages/expo-camera'
---
...
### `Camera.getAvailableVideoCodecsAsync():string[]`

(iOS only). Checks the available video codecs for the camera.

#### Returns

A promise that resolves to a list of the available codecs that can be used to record videos.
## Props
